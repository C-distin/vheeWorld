    ...
    <main className="min-h-screen w-full">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="grid grid-cols-1 gap-16 md:grid-cols-2 items-center">
            ...
            <div className="space-y-6">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-sm font-semibold text-blue-500 hover:text-blue-700 transition group mt-2">
            ...
            <div className="relative">
              ...
              <div className="relative bg-white border border-gray-100 rounded-2xl p-10 shadow-[0_8px_40px_rgba(59,130,246,0.08)]">
                ...
                <div className="flex items-start gap-4 pl-6">
                  <IconQuote size={40} className="text-blue-300 shrink-0 mt-1" />
                </div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-12">
          <div className="w-full max-w-4xl">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-[0_0_80px_rgba(168,85,247,0.25)] ring-1 ring-white/10">
              <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-purple-400/50 to-transparent z-10 pointer-events-none" />
              <iframe
      ...
      <section className="relative w-full py-12 px-4 sm:px-6 lg:px-8 bg-gray-100">
        <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden">
          <div className="relative w-full px-8 py-20 text-center bg-[linear-gradient(135deg,#2a3fc7_0%,#3b4fd4_30%,#5b3fa8_70%,#7b3fa0_100%)]">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/donate"
                className="px-8 py-3 bg-white text-blue-700 text-sm font-bold tracking-widest uppercase rounded-md hover:bg-white/90 transition min-w-[160px] text-center">
                Donate Now
              </Link>
              <Link
                href="/volunteer"
                className="px-8 py-3 bg-transparent text-white text-sm font-bold tracking-widest uppercase rounded-md border border-white/50 hover:bg-white/10 transition min-w-[160px] text-center">
                Volunteer With Us
              </Link>
            </div>
          </div>
