            ...
            <div className="grid grid-cols-1 gap-16 md:grid-cols-2 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-[1.05rem] leading-relaxed text-gray-500">
                  ...
                  mentorship, and resource provision — the foundation aims to uplift and empower children who are at
                  risk of living on the streets.
                </p>

                <p className="text-[1.05rem] leading-relaxed text-gray-500">
                  By offering access to education and mentorship programs, the foundation equips children with the
                  skills and knowledge to break the cycle of poverty and create a better future for themselves.
                </p>
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-12">
            ...
            <div className="w-full max-w-3xl border-l-2 border-purple-400/50 pl-6 text-left">
              <p className="text-lg sm:text-xl font-medium leading-relaxed text-white/80 italic">
                "Eradicating streetism by empowering the vulnerable with the resources, mental health support, and
                shelter they need to thrive."
              </p>
          ...
          <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden">
            <div
              ...
              <p className="mt-5 text-base sm:text-lg text-white/70 max-w-md mx-auto leading-relaxed">
                Join us in our mission to build a more equitable world. Every donation goes directly to our local
                programs and community development projects.
              </p>
